FROM {{.Env.DK_FROM_IMAGE}} as openssl
...
ENV NAME=unbound \
    ...
    UNBOUND_SHA256={{.Env.UNBOUND_SHASUM}} \
    UNBOUND_DOWNLOAD_URL=https://www.unbound.net/downloads/unbound-{{.Env.UNBOUND_VERSION}}.tar.gz \
    VERSION=0
